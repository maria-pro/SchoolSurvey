...
cols_engB <- c("#ff6800", "#f8bb83", "#fc8b00")
...
fig8%>%
  ggplot(aes(x=Sector, y=n, fill=interaction (Sector, year)))+
...
#  guides(
 #   fill = guide_none(),
 #   alpha = guide_legend(
#      override.aes = list(fill = c(0.7, 1)
 #     )
#    )
#  ) +
    theme(
...
scale_fill_manual(
labels= c("Government 2021", 
           "Catholic 2021",
           "Independent 2021",
           "All schools 2021",
           "Government 2022", "Catholic 2022","Independent 2022", "All schools 2022"), 
  values=c('#adc3de','#f19fa0', '#c2d3a1', '#c5c5c5', '#4e81bc','#e32f2a', '#7da52b', '#848484'))+

#, 
#guide='none')+
#  scale_alpha_manual(values = c("2021" = .5,
#                                "2022"=1))
...
geom_text(aes(label = n), 
          ...
          size = 3,
          vjust=-0.5)+
  scale_y_continuous("Number of action items achieved (out of 23)", limits = c(0, 23), breaks = c(0, 5, 10, 15, 20, 23))+
...
#    scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+
  ...
  scale_y_continuous(limits = c(0, 1.1), breaks = seq(0, 1, 0.20), labels = scales::percent)+
    ...
    geom_text(aes(label = round(Mean*100), group = fct_rev(engB), fill=fct_rev(engB)), 
        ...
        hjust = - 0.2,
        size=2.75)+
  scale_fill_manual(breaks = c("Low", "Med", "High"), values=c("#f8bb83", "#fc8b00","#ff6800"))
