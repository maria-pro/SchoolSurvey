...
He hath brought many captives home to Rome
Whose ransoms did the general coffers fill:
Did this in Caesar seem ambitious?## Aim
...
plot_ly(data=count(data2021, Sector), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2021: Participants by sector")
...
plot_ly(data=count(data2022, Sector), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2022: Participants by sector")
...
plot_ly(data=count(data2021, Type), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2021: Participants by school type")
...
plot_ly(data=count(data2022, Type), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2022: Participants by school type")
...
plot_ly(data=count(data2021, SES), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2021: Participants by SES")
...
plot_ly(data=count(data2022, SES), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2022: Participants by SES")
...
plot_ly(data=count(data2021, ADII), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2021: Participants by ADII")
...
plot_ly(data=count(data2022, ADII), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2022: Participants by ADII")
...
plot_ly(data=count(data2021, Metro), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2021: Participants by Metro/non-metro")
...
plot_ly(data=count(data2022, Metro), 
  ...
  layout(legend = list(orientation = 'h'),
         title="2022: Participants by Metro/non-metro")

```

Figure 6. Participants by DET region N/A
Figure 7. Participants by eSmart status
N/A
...
data2021%>%
  ...
  geom_col(width = 0.5)+
  labs(title="2021:average (median) number of eSmart action items completed by sector (out of 23)",
        x ="Sector", y = " ")+
...
data2022%>%
  ...
  ggplot(aes(x=Sector, y=n, fill=Sector))+
  geom_col(width = 0.5)+
  labs(title="2022:average (median) number of eSmart action items completed by sector (out of 23)",
        x ="Sector", y = " ")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(),
axis.line = element_line(colour = "black"))
...
Figure 21. two bar charts that include the 2021 vs. 2022 results for the six schools that completed the instrument both years -- by Domain and total for Part A, and by Focus Area and total for Part B.
## Results
