...
plot_ly(data=count(data2021, Sector), 
        ...
        type = 'pie',
    #    marker = list( colors = ~dplyr::recode(data2021$Sector, !!!colors_list_sector)),
...
#----PLOT
fig11%>%count(Categories)

fig11%>%
  ungroup%>%
#  mutate(
#    Categories=as_factor(Categories,levels=c(
...
#    scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+
  ...
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.20), labels = scales::percent)+
  
    geom_text(aes(label = round(Mean*100), group = Sector), 
...
#    scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+
  ...
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.20), labels = scales::percent)+
    ...
    geom_text(aes(label = round(Mean*100), group = SES), 
            position = position_dodge(width = 1), 
            hjust = -0.2, vjust = 0.5, size = 3)+
...
#    scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+
  ...
  scale_y_continuous(limits = c(0, 80), breaks = seq(0, 80, 10))+
    ...
    geom_text(aes(label = round(Mean), group = Sector), 
            position = position_dodge(width = 1), 
            hjust = -0.2, vjust = 0.5, size = 3)+
  scale_fill_manual(values=colors_list_sector)
...
#    scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+
  ...
  scale_y_continuous(limits = c(0, 80), breaks = seq(0, 80, 10))+  
    geom_text(aes(label = round(Mean), group = SES), 
            position = position_dodge(width = 1), 
            hjust = -0.2, vjust = 0.5, size = 3)+
  scale_fill_manual(values=colors_list_SES)
...
#    scale_x_discrete(labels = function(x) str_wrap(x, width = 10))+
  ...
  scale_y_continuous(limits = c(0, 80), breaks = seq(0, 80, 10))+  
    geom_text(aes(label = round(Mean), group = Type), 
            position = position_dodge(width = 1), 
            hjust = -0.2, vjust = 0.5, size = 3)+
